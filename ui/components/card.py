...
def _paint_x_button(frame: ctk.CTkFrame, card: Card) -> ctk.CTkButton:
    ...
    return ctk.CTkButton(frame, text="\u00d7", command=lambda: polutils.patterns.event.post("remove_card", card), text_font=('Roboto', 12, "bold"), fg_color=frame.fg_color, hover_color=frame.fg_color, border_width=0, border=0, width=0, height=0, corner_radius=10)
